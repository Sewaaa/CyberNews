  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "cyan-glow":     "0 0 20px rgba(0,255,229,0.4), 0 0 40px rgba(0,255,229,0.15)",
        "red-glow":      "0 0 16px rgba(239,68,68,0.5)",
        "card-dark":     "0 4px 24px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.04)",
        "card-dark-hover":"0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(0,255,229,0.18), inset 0 1px 0 rgba(255,255,255,0.07)",
      },
      animation: {
